...
export default function HeroSection() {
  const item = {
    ...
    video:
      "https://res.cloudinary.com/sayed12m/video/upload/v1764090993/axsku7q2bbkmea3n0hwy.mp4", // ⭐ replace with your video
    desc: `At Valerian Gardens Design, we help to bring beauty, harmony, and functionality to outdoor spaces. Whether you're dreaming of a peaceful garden retreat, a modern outdoor living area, or a complete landscape transformation, we're here to help you design a space that reflects your style and enhances your lifestyle.
